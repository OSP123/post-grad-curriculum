<p align="center">
  <img src="http://i.imgur.com/LW0DeGQ.png" alt="grad">
</p>
...
- [Post Grad Learning Path](#post-grad-learning-path)
...
<p align="center">
  <img width="400" src="https://media.giphy.com/media/QJvwBSGaoc4eI/giphy.gif" alt="starting-line" />
</p>
...
1. Always have a side project - This can always count towards your coding experience, even if you are working another job.
2. Practice small coding challenges - This is a good practice you can do daily and will keep your skills fresh.
3. Programming is like a foreign language, if you don’t use it and practice it normally, it will be harder to get back into it.

_MOST IMPORTANT: **NEVER STOP CODING**_
   
To help you get comfortable with doing the above you can start with:

#### Post Grad Learning Path

- [Becoming Employer Ready](#becoming-employer-ready)
- [Base Materials](#base-materials)
- [Expanding from the Fundamentals](#expanding-from-the-fundamentals)
...
<p align="center">
  <img width="400" src="https://media.giphy.com/media/GpvGNDIruGFQk/giphy.gif" alt="crushed-it" />
</p>
...
<p align="center">
  <img width="400" src="https://media.giphy.com/media/IPbS5R4fSUl5S/giphy.gif" alt="study" />
</p>

1. **Go through the material you feel behind on** by checking the [topics](https://drive.google.com/file/d/0BzZc9xnaQ0vqcWVEd3hPcHRhQTg/view?usp=sharing) you still don’t grasp
...
2. In order to get practice with the concepts you feel behind on, do the following:
    ...
    2. Complete the Code Drills from [this set of Code Drills](https://github.com/jeromechenette/coding-bootcamp-post-bootcamp#post-coding-boot-camp)
        - Credit to [Jerome Chennette(@jeromechenette)](https://github.com/jeromechenette)!

3. **Apply to positions** that are more in line with the concepts that fit your strengths. If you feel strong in front end development, apply to jobs in front end development.

4. **Practice for interviewing** by completing algorithms on the whiteboard
    - [Here is a resource we've developed for whiteboard and interview prep](https://www.gitbook.com/read/book/the-coding-bootcamp/whiteboarding-algorithms-and-interview-questions?key=technicalInterview) (make sure to have the key-value pair in the query params or it won't work!)
...
<p align="center">
  <img width="400" src="https://media.giphy.com/media/fhAwk4DnqNgw8/giphy.gif" alt="level-up">
</p>
...
1. If you feel that you have the fundamentals of the program down, it's now time to start learning more advanced topics and adding those concepts to the applications you build.
    ...
    - **What is the roadmap?** _i.e. where am I going?_
...
## Contributing
Project management is done on [Zenhub](https://www.zenhub.com/) board, with tracking done via [Github issues](OSP123/post-grad-curriculum/issues).

1. [Fork the repo](https://help.github.com/en/articles/fork-a-repo)
2. [Open a pull request to submit your contribution](https://help.github.com/en/articles/creating-a-pull-request-from-a-fork)
3. That's it!
